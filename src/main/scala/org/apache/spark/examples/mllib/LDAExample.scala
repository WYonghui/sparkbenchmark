...
/**
  ...
  * spark-submit --master spark://inode39:7077 --deploy-mode client --class org.apache.spark.examples.mllib.LDAExample \
      spark-benchmark-1.0-SNAPSHOT-jar-with-dependencies.jar --maxIterations 5 \
