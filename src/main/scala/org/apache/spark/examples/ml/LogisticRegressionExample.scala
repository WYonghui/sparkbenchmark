...
/**
  ...
  * spark-submit --master spark://inode39:7077 --deploy-mode client --class org.apache.spark.examples.ml.LogisticRegressionExample \
      spark-benchmark-1.0-SNAPSHOT-jar-with-dependencies.jar --regParam 0.3 --elasticNetParam 0.8 \
      /hadoop-5nodes/dataset/mllib/sample_svm_data.txt
  */
