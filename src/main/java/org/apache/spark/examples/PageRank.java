 ...
 * spark-submit --master spark://node91:6066 --deploy-mode cluster --class org.apache.spark.examples.PageRank \
      --name PageRank spark-benchmark-1.0-SNAPSHOT.jar hdfs://node91:9000//wyh/testDataSet/out.web-Google 3 \
      hdfs://node91:9000//wyh/output/pagerank/001
 * </pre>
 */
public class PageRank {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 3) {
            System.err.println("Usage: JavaPageRank <srcFile> <number_of_iterations> <outFile>");
            System.exit(1);
        }
        ...
        SparkSession spark = SparkSession
                .builder()
                .appName("PageRank")
//                .config("spark.locality.wait", 10000)
//                .config("spark.default.parallelism", 800)
        ...
        //Collect all URL ranks and output to file
